...
<table class="data_list_table">
    ...
    <tr>
        ...
        <td class="list_data_op">
            <img onclick="window.location.href = 'http://localhost:8080/crm/sale/dispatch'" title="指派"
                 src="../images/bt_linkman.gif" class="op_button"/>
            <img onclick="to('sale/edit');" title="编辑" src="../images/bt_edit.gif" class="op_button"/>

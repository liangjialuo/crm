...
<table class="data_list_table">
	...
	<tr>
		...
		<td class="list_data_op">
			<img onclick="to('sale/dev_plan');" title="制定计划" src="../images/bt_plan.gif" class="op_button" />
			<img onclick="to('sale/dev_execute');" title="执行计划" src="../images/bt_feedback.gif" class="op_button" />
	...
	<tr>
		...
		<td class="list_data_op">
			<img onclick="to('sale/dev_detail');" title="查看" src="../images/bt_detail.gif" class="op_button" />
		</td>
	</tr>
	<tr>
